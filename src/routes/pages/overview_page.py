...
def render_overview_page() -> str:
    ...
    last_workout = db_select_service.get_last_completed_workout(user_id=user_id)
    if last_workout and len(last_workout) > 0:
        last_exercises_workout = (
            db_select_service.get_exercises_workouts_by_workout_ids(
